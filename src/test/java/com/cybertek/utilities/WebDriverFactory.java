...
public class WebDriverFactory {  // this method will give us the webdriver(driver obj)

    public static WebDriver getDriver (String browserType){ // we put webdriver because is what we return
