...
public class iframeTest {
    ...
    public void test1() throws InterruptedException {
        ...
        //1.Switch to baby HTML using by name or ID attribute of iframe
        driver.switchTo().frame("mce_0_ifr");

        //clear what we have in that text box before sendkeys
        ...
        //2.Switching to baby HTML with INDEX but the main HTML is not count, so we have only one frame then the
        // index starts from 0
        ...
        //second way to switch parent (main HTML)
        driver.switchTo().parentFrame();

        //3.USING WEBELEMENT to switch to baby HTML
